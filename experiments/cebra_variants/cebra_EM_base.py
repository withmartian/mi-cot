...
OUTPUT_DIR = "/home/abir19/scratch/abir19/SDS_results/cebra_em_base"
...
if __name__ == "__main__":
    ...
    for path in DATASETS:
        ...
        for k in K_SWEEP:
            p, st, s, C_mat, T_hard, score, tqs_score, k_eff, r2, bic = fit_and_evaluate(cebra_seqs, pca_seqs, labels, k)
            sss_scores[k] = score
            ...
            print(f"  K={k}: SSS={score:.4f} TQS={tqs_score:.4f} BIC={bic:.1f} R²={r2:.4f}", flush=True)
        ...
        result = {
            "metadata": {
                ...
                "config": {
                    ...
                    "pca_dim": PCA_DIM,
                    "cebra_epochs": CEBRA_EPOCHS,
                    "n_iters_slds": N_ITERS_SLDS,
                }
            },
